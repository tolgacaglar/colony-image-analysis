...
# TimeScan images are saved in parameter t**
tnum = 0    # Number of timepoints


# Obtain the properties from an _Properties XML file. 
xml_path = ""

snum = 0    # Number of tilescanned images

# Zscan images are saved in parameter z**.
znum = 0    # Number of z-scan images
